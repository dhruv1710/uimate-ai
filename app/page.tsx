            ...
            <div className="pt-4">
              <div className="relative max-w-md">
                ...
                <Card className="relative bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-lg p-2 flex">
                  ...
                  />
                  <Button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 ml-2">
                    Summon AI Review
                    <Sparkles className="ml-2 h-4 w-4" />
                  </Button>
                </Card>
              </div>
              <p className="text-xs text-slate-400 mt-2 ml-1">Instant analysis. No credit card required.</p>
            </div>
          </div>
